...
class LightningWrapper(pl.LightningModule):
    ...
    def forward_pairwise(self, data_1, data_2):
        ...
        result_1, result_2 = self.model(data_1), self.model(data_2)
        energy_1, energy_2 = result_1['energy'], result_2['energy']
        if self._compute_forces:
            forces_1, forces_2 = result_1['forces'], result_2['forces']
        forces = (
